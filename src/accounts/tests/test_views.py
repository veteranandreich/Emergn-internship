...
class SuccessfulSignUpTests(TestCase):
    ...
    def setUp(self):
        ...
        self.profiles_page = reverse('profiles:index')
        self.login_page = reverse('accounts:login')

    def test_redirects_to_index_page(self):
        self.assertRedirects(self.response, self.login_page, target_status_code=200)

    def test_user_creation(self):
        self.assertTrue(User.objects.exists())

    def test_user_authentication(self):
        response = self.client.get(self.profiles_page)
